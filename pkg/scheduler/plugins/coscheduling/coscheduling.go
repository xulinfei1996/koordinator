...
func (cs *Coscheduling) RegisterControllers(controllersMap controllers.ControllersMap) {
	...
	controllersMap.RegisterController("podGroupController", podGroupController)
	klog.Infof("Register podGroupController")
}
